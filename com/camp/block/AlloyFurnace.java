...
public class AlloyFurnace extends BlockContainer{
	...
	protected AlloyFurnace(boolean isActive)
	{
		super(Material.rock);
	...
	{
		this.blockIcon = iconRegister.registerIcon(StringLibrary.MODID + ":alloy_furnace_sides");
		this.iconFront = iconRegister.registerIcon(StringLibrary.MODID + (this.isActive ? ":alloy_furnace_front_on" : ":alloy_furnace_front_off"));
	}
	...
	private void setDefaultDirection(World world, int x, int y, int z){
		...
		public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ){
			if(!world.isRemote)
			{
				...
				FMLNetworkHandler.openGui(player, MainRegistry.instance, ByteLibrary.GUI_ALLOY_FURNACE, world, x, y, z);
		...
		public static void updateAlloyFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord)
		{
			...
			if(active)
			{
				worldObj.setBlock(xCoord, yCoord, zCoord, BlockManager.alloyFurnaceActive);
			}
			else
				worldObj.setBlock(xCoord, yCoord, zCoord, BlockManager.alloyFurnaceIdle);
