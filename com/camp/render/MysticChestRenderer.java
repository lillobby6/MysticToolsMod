...
public class MysticChestRenderer extends TileEntitySpecialRenderer
{
   // private static final ResourceLocation field_147505_d = new ResourceLocation("textures/entity/chest/normal_double.png");
    private static final ResourceLocation field_147504_g = new ResourceLocation(StringLibrary.MODID + ":textures/blocks/mystic_chest.png");
    private ModelChest field_147510_h = new ModelChest();
    private ModelChest field_147511_i = new ModelLargeChest();
    private boolean field_147509_j;
    private static final String __OBFID = "CL_00000965";

    public MysticChestRenderer()
    {
    ...
    public void renderTileEntityAt(TileEntityMysticChest p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        int i;
