...
public class MysticPortal extends BlockBreakable
{
 ...
 /*   public boolean func_150000_e(World p_150000_1_, int p_150000_2_, int p_150000_3_, int p_150000_4_)
    {
        MysticPortal.Size size = new MysticPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
        MysticPortal.Size size1 = new MysticPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
    ...
    public static class Size
        {
            ...
            public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
            {
                ...
                this.field_150863_d = MysticPortal.field_150001_a[p_i45415_5_][0];
                this.field_150866_c = MysticPortal.field_150001_a[p_i45415_5_][1];
            ...
            protected int func_150853_a(int p_150853_1_, int p_150853_2_, int p_150853_3_, int p_150853_4_)
            {
                ...
                for (i1 = 0; i1 < 22; ++i1)
                {
                    ...
                    if (block1 != BlockManager.toslotriumBlock)
                    {
                        break;
                    }
                }
                ...
                block = this.field_150867_a.getBlock(p_150853_1_ + j1 * i1, p_150853_2_, p_150853_3_ + k1 * i1);
                return block == BlockManager.toslotriumBlock ? i1 : 0;
            }
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    ...
                    {
                        k = this.field_150861_f.posX + j * Direction.offsetX[MysticPortal.field_150001_a[this.field_150865_b][1]];
                        l = this.field_150861_f.posZ + j * Direction.offsetZ[MysticPortal.field_150001_a[this.field_150865_b][1]];
                        ...
                        if (block == BlockManager.mysticPortal)
                        {
                            ++this.field_150864_e;
                        }
                        ...
                        if (j == 0)
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[MysticPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[MysticPortal.field_150001_a[this.field_150865_b][0]]);

                            if (block != BlockManager.toslotriumBlock)
                            {
                                break label56;
                            }
                        }
                        ...
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[MysticPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[MysticPortal.field_150001_a[this.field_150865_b][1]]);
                ...
                {
                    j = this.field_150861_f.posX + i * Direction.offsetX[MysticPortal.field_150001_a[this.field_150865_b][1]];
                    k = this.field_150861_f.posY + this.field_150862_g;
                    l = this.field_150861_f.posZ + i * Direction.offsetZ[MysticPortal.field_150001_a[this.field_150865_b][1]];

                    if (this.field_150867_a.getBlock(j, k, l) != BlockManager.toslotriumBlock)
                    {
            ...
            {
                return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == Blocks.fire || p_150857_1_ == BlockManager.mysticPortal;
            }
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    for (int l = 0; l < this.field_150862_g; ++l)
                    {
                        ...
                        this.field_150867_a.setBlock(j, i1, k, BlockManager.mysticPortal, this.field_150865_b, 2);
                    }
                }
            }
        }
