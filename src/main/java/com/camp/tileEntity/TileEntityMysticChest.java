...
public class TileEntityMysticChest extends TileEntityChest{
   ...
   /* public TileEntityMysticChest adjacentChestZNeg;
    public TileEntityMysticChest adjacentChestXPos;
    public TileEntityMysticChest adjacentChestXNeg;
    public TileEntityMysticChest adjacentChestZPos;*/
    ...
    public void readFromNBT(NBTTagCompound nbtTag)
    {
        ...
        if (nbtTag.hasKey("Mystic Chest", 8))
        {
            this.customName = nbtTag.getString("Mystic Chest");
        }
    ...
    private void func_145978_a(TileEntityMysticChest p_145978_1_, int p_145978_2_)
    {
   ...
   // }
    /*public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityMysticChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityMysticChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityMysticChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (TileEntityMysticChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
